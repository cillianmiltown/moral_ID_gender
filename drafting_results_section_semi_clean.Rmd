...
```{r child = 'H1_semi_clean.Rmd'}
```

# H2 Age Differences


```{r child = 'H2_semi_clean.Rmd'}
```


# H3 Cultural Differences in Symbolization

```{r child = 'H3_semi_clean.Rmd'}
```



# H4 Cultural Differences in Internalization

```{r child = 'H4_semi_clean.Rmd'}
```
