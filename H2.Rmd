...
We conducted a series of correlations test if age was related to internalization across all countries.  There was a significant correlation between age and internalization in `r total_sig` countries. Of these, there was a positive correlation between age and internalization in `r pos` countries, and a negative correlation in `r neg` countries (see Supplementary Materials Table S_X).
