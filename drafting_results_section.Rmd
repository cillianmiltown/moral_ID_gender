...
We conducted a series of independent-samples t-tests to test for gender differences in internalization across all countries. We found this effect across `r total_sig` countries (see Supplementary Materials Table S_X).
...
`r sprintf("%.2f",t1)`
, *p* `r paste(p_report(p2))`.
We conducted a series of independent-samples t-tests to test for gender differences in symbolization across all countries. We found this effect across `r total_sig` countries (see Supplementary Materials Table S_X).
