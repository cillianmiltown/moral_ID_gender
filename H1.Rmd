...
int_sig_pos <- test1[which(test1$`mean F`>test1$`mean M`),] # subset(test1, d > 0)
int_sig_neg <- test1[which(test1$`mean F`<test1$`mean M`),] # subset(test1, d < 0)
int_non_sig <- test2
...
symb_sig_pos <- test1[which(test1$`mean F`>test1$`mean M`),] # subset(test1, d > 0)
symb_sig_neg <- test1[which(test1$`mean F`<test1$`mean M`),] # subset(test1, d < 0)
symb_non_sig <- test2
